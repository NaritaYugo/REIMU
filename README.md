...
低スペックGPUでも海全体とインタラクションできる**リアルタイム流体シミュレーションエンジン**です。

## デモ

[![Demo](https://img.youtube.com/vi/wG5bqn34c7w/0.jpg)](https://youtu.be/wG5bqn34c7w)

[Windows Demo ダウンロード](https://github.com/NaritaYugo/REIMU/releases/tag/v1.0)
...
本プロジェクトでは、Unity（URP）とCompute Shaderを用いて、特性の異なる3種類の流体手法を組み合わせることで、
